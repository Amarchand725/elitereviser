    						...
    						<div class="card-body">
    							<div class="d-flex flex-row">
    								...
    								<div class="ms-2 align-self-center">
    									...
    									<h6 class="text-muted mb-0 ml-2">Total Completed Jobs</h6>
    								</div>
    							</div>
    						</div>
    					</a>
					    ...
					    <a href="{{ url('admin/orders') }}">
							...
							<div class="d-flex flex-row">
								...
								<div class="ms-2 align-self-center">
									...
									<h6 class="text-muted mb-0 ml-2">New Jobs</h6>
								</div>
							</div>
						</div>
					    </a>
					    ...
					    <a href="{{ url('admin/orders') }}">
							...
							<div class="d-flex flex-row">
								...
								<div class="ms-2 align-self-center">
									...
									<h6 class="text-muted mb-0 ml-2">Inprogress Jobs</h6>
								</div>
							</div>
						</div>
					    </a>
				...
				<div class="col-lg-3 col-md-6">
					<div class="card">
					    <a href="{{ url('admin/orders') }}">
							...
							<div class="d-flex flex-row">
								<div class="round round-lg text-white d-flex align-items-center justify-content-center rounded-circle bg-danger">
									<img  src="{{ asset('public/assets/website/images/mart01.png')}}">
								</div>
								<div class="ms-2 align-self-center">
									<h3 class="mb-0 ml-2">54</h3>
									<h6 class="text-muted mb-0 ml-2">Total Jobs</h6>
								</div>
							</div>
						</div>
					    </a>
