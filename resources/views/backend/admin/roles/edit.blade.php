				...
				<div class="card">
					<div class="card-body">
						...
						<div class="table-responsive">
							<div class="container">
								<form method="post" id="event-form" name="even_form" action="{{ url('/admin/role/update') }}" enctype="multipart/form-data">
									@csrf
									...
									<div class="modal-body">
										<div class="row">
											<div class="col-md-6">
												...
												<input type="text" name="name" id="name" value="{{ $details->name }}" class="form-control" placeholder="Enter role name">
												...
												<div class="card col-sm-4">
													<ul class="list-group list-group-flush temp">
														...
														@foreach($model->hasGroupPermissions as $permission)
															<?php $counter++; $boo = true;  ?>
															@foreach($details->hasPermissions as $assigned)
																@if($permission->id==$assigned->permission_id)
																	<li class="list-group-item">
																		<div class="form-check form-check-inline">
																			<input class="form-check-input" name="permissions[]" type="checkbox" id="perm-{{ $counter }}" checked value="{{ $permission->id }}">
