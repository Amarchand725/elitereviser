								...
								<tbody id="body">
									...
									@foreach ($models as $model)
										<tr>
											...
											<td>
												<button class="btn btn-primary btn-sm approve-btn" value="{{ $model->id }}" data-toggle="tooltip" data-original-title="Approve Comment" id=""><i class="fa fa-edit"></i></button>
											</td>
										</tr>
									@endforeach
								</tbody>
	...
	<script>
		...
		$(document).ready(function(){
			...
			function fetchAll(date, status){
				$.ajax({
					url: '{{ url("/admin/audio/all-comments") }}/{{ $song_id }}',
					type: 'post',
