				...
				<div class="col-md-12">
					<div class="row col-md-12">
						...
						<div class="search-button" style="float:right;">
							...
							<button href="#" class="btn btn-success" data-toggle="modal" data-target="#add-artist">Add New Membership</button>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLongTitle">Add New Membership</h5>
                        ...
                        <div class="row">
							<div class="col-md-12">
								...
								<select name="searchData"  class="select2" style="width: 100%">
									...
									<option value="2">6/M</option>
                                    <option value="2">1/Y</option>
								</select>
							</div>
						</div>
                        <div class="row">
