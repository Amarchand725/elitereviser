...
@section('content')
		...
		<div class="container-fluid">
			<div class="row page-titles">
				<div class="col-md-5 col-8 align-self-center">
					<h3 class="text-themecolor m-b-0 m-t-0">All Audience</h3>
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
						<li class="breadcrumb-item active">All Audience</li>
					</ol>
				</div>
					...
					<div class="d-flex m-t-10 justify-content-end">
						<div class="d-flex m-r-20 m-l-10 hidden-md-down">
							<div class="chart-text m-r-10">
								<h6 class="m-b-0"><small>Total Audience</small></h6>
					...
					<div class="row col-md-12">
						<div class="col-md-3" style="margin-bottom: 10px;">
							<div class="search-field">
								<input type="text" class="form-control" name="" id="search_product_name" placeholder="Search Audience Name">
							</div>
						</div>
						...
						<div class="search-button" style="float:right;">
							...
							<button href="#" class="btn btn-success" data-toggle="modal" data-target="#add-artist">Add Audience</button>
			...
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						<h4 class="card-title">All Audience</h4>
								...
								<tbody>
                                  <tr>
                                   <td>01</td>
                                    ...
                                    <td>+987654321</td>
                                    <td><img src="{{asset('images/art-1.png')}}" style="width: 50px" height="50px" alt=""></td>
                                    <td>Admin</td>
                                    <td>Active</td>
                                    <td>02/02/2020</td>
	...
	<!-- Add brand Modal -->
	 <div class="modal fade" id="add-audience" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLongTitle">Add New Audience</h5>
				...
				<form method="post" id="brandForm" name="brandForm" action="javascript:void(0)" enctype="multipart/form-data">
					...
					<div class="modal-body">
						...
						<div class="row">
							<div class="col-md-12">
								<label for="">Audience Full Name</label>
								<input type="text" name="name" class="form-control" placeholder="Enter Audience Full Name">
							</div>
						</div>
                        <div class="row">
							<div class="col-md-12">
