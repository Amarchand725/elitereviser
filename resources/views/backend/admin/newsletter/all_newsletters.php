	...
	<div class="container-fluid">
		...
		<div class="row page-titles">
			<div class="col-md-5 col-8 align-self-center">
				<h3 class="text-themecolor m-b-0 m-t-0">All Newsletters</h3>
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
					<li class="breadcrumb-item active">All Newsletters</li>
				</ol>
			</div>
				...
				<div class="d-flex m-t-10 justify-content-end">
					<div class="d-flex m-r-20 m-l-10 hidden-md-down">
						<div class="chart-text m-r-10">
							<h6 class="m-b-0"><small>Total Newsletters</small></h6>
							<h4 class="m-t-0 text-info"><?php if(!empty($all_records)){
									echo str_pad(count($all_records),4,0,STR_PAD_LEFT);?>
								<?php }?></h4></div>
				...
				<div class="row">
					<div class="col-md-9" style="margin-bottom: 10px;">
						<div class="search-field">
							<input type="text" class="form-control" name="searchData" id="searchData" placeholder="Search by name | email ">
						</div>
					</div>
					<div class="col-md-3">
		...
		<script type="text/javascript">
			...
			$(function() {
				...
				function ajaxlistCategories(page_url = false)
				{
					...
					var base_url = '<?php echo base_url('all-newsletters-with-ajax/0') ?>';
					if(page_url == false) {
		...
		<script type="text/javascript">
			function deleteData(id) {
				swal({title:"",
					text:"Are you sure you want to delete this newsletter?",icon:"error",
					...
					if (isConfirm) {
						$.ajax({
							type:"POST",
							url:"<?php echo base_url('delete-newsletter/'); ?>"+id,
							dataType:'JSON',
							success:function(data){
								if(data==true){
									$('#tr-remove'+id).fadeOut(500);
									swal({title:"Successfully!",text:"Newsletter deleted successfully",icon:"success",timer:2000});
								}
							},
							error:function (er) {
								console.log(er);
