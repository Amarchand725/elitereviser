...
<body>
    ...
    <!-- ============================================================== -->
    <section id="wrapper">
        <div class="login-register" style="background-image:url( {{ asset('public/assets/admin/main-assets/images/background/login-register.jpg') }}">
    ...
    <!-- Style switcher -->
    <!-- ============================================================== -->
	<script src="{{ asset('public') }}/assets/admin/js/jasny-bootstrap.js"></script>
                    ...
                    success: function(data) {
                        if (data != false) {
                            ...
                            if(data =='admin'){
                                ...
                                setTimeout(function() {
                                    location.href = '{{ route("editor.dashboard") }}'
                                }, 2500);
                            }else{ 
                                setTimeout(function() {
                                    location.href = '{{ route("my_orders") }}'
                                }, 2500);
                            }
                        } else {
