				...
				<div class="card">
					<div class="card-body">
						...
						<div class="table-responsive">
							<div class="container">
								<form method="post" id="event-form" name="even_form" action="{{ url('admin/bonusfootage/store') }}" enctype="multipart/form-data">
									@csrf
										...
										<div class="row">
											...
											<div class="col-md-6">
												...
												<select name="strategy" id="" class="form-control" required>
													<option value="1" {{ old('strategy')==1?'selected':'' }}>Free</option>
													<option value="2" {{ old('strategy')==2?'selected':'' }}>Premium</option>
												</select>
									...
									<div class="modal-footer">
										...
										<button type="submit" class="btn btn-success" id="sbt-btn">Submit</button>
									</div>
								</form>
							</div>
						</div>
