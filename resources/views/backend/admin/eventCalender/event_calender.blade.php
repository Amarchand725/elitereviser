				...
				<div class="col-md-12">
					<div class="row col-md-12">
						...
						<div class="search-button" style="float:right;">
							...
							<button href="#" class="btn btn-success" data-toggle="modal" data-target="#add-artist">Add New Event</button>
							...
							<table class="table" id="all_record">
								...
								<tbody>
                                  <tr>
                                   <td>01</td>
                                    <td>Justin Bieber</td>
                                    <td>02/02/2020 9:00 pm - 1:00 am </td>
                                    <td>Hilton Park</td>
                                    <td>500</td>
                                    <td>200</td>
                                    <td>Admin</td>
                                    <td>Active</td>
                                    <td class="forlinks"><a href=""  class="btn btn-sm btn-icon btn-warning" data-toggle="tooltip" title="" data-original-title="Update Artist"><i class="mdi mdi-border-color"></i></a> <a href=""  class="btn btn-sm btn-icon btn-danger" style="color:#fff;" data-toggle="tooltip" title="" data-original-title="Delete Artist"><i class="fa fa-trash-alt"></i></a></td>
                                </tr>
					...
					<div class="modal-body">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<select name="searchData"  class="select2" style="width: 100%">
									<option value="All">Select</option>
									<option value="1">John </option>
									<option value="2">Justin</option>
                                    <option value="2">Poupye</option>
								</select>
							</div>
						</div>
                        ...
                        <div class="row">
							<div class="col-md-12">
								...
								<select name="searchData"  class="select2" style="width: 100%">
									<option value="All">Hilton Park</option>
									<option value="1">North wave city</option>
									<option value="2">Packages Mall</option>
                                    <option value="2">Elon Park</option>
								</select>
							</div>
						</div>
                        <div class="row">
