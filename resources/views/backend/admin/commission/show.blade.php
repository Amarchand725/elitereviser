								...
								<tbody id="body">
									...
									@foreach ($gallery->hasAllImages as $model)
										<tr id="tr-remove-{{ $model->id }}">
											<td>{{ $total_records-- }}.</td>
											<td>
												<img src="{{ asset('images/gallery') }}/{{ $model->image }}" width="80" height="60" alt="">
											</td>
											...
											<td class="forlinks">
												<button class="btn btn-info btn-sm active-btn" value="{{ $model->id }}" title="Active or in-active" id="">Status</button>
