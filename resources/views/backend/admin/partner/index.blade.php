		...
		<div class="container-fluid">
			<div class="row page-titles">
				<div class="col-md-5 col-8 align-self-center">
					<h3 class="text-themecolor m-b-0 m-t-0">All Partners</h3>
					<ol class="breadcrumb">
					...
					<div class="d-flex m-t-10 justify-content-end">
						<div class="d-flex m-r-20 m-l-10 hidden-md-down">
							<div class="chart-text m-r-10">
								<h6 class="m-b-0"><small>Total Partners</small></h6>
				...
				<div class="col-md-12">
					<div class="row col-md-12">
						...
						<div class="search-button" style="float:right;">
							...
							<a href="{{ url('/admin/partner/create') }}" class="btn btn-success">Add Partner</a>
	...
	<script>
		...
		$(document).ready(function(){
			...
			function fetchAll(title, status){
				$.ajax({
					url: '{{ url("/admin/partner/get_all_partners") }}',
					type: 'post',
