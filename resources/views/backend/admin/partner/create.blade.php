		...
		<div class="container-fluid">
			<div class="row page-titles">
				<div class="col-md-5 col-8 align-self-center">
					<h3 class="text-themecolor m-b-0 m-t-0">Add New Partner</h3>
					<ol class="breadcrumb">
				...
				<div class="card">
					<div class="card-body">
						...
						<div class="table-responsive">
							<div class="container">
								<form method="post" id="event-form" name="even_form" action="{{ url('admin/partner/store') }}" enctype="multipart/form-data">
									@csrf
									<div class="modal-body">
										...
										<div class="row">
											<div class="col-md-6">
												<label for="">Upload Logo <span style="color:red">*</span></label>
