		...
		<div class="container-fluid">
			<div class="row page-titles">
				<div class="col-md-5 col-8 align-self-center">
					<h3 class="text-themecolor m-b-0 m-t-0">Update Coupon</h3>
					<ol class="breadcrumb">
				...
				<div class="card">
					<div class="card-body">
						...
						<div class="table-responsive">
							<div class="container">
								<form method="post" id="event-form" name="even_form" action="{{ url('admin/coupon/update') }}" enctype="multipart/form-data">
									@csrf
									...
									<div class="modal-body">
										...
										<div class="row">
											<div class="col-md-6">
												...
												<input type="text" name="discount" value="{{ $details->discount }}" id="discount" class="form-control" placeholder="Enter discount">
