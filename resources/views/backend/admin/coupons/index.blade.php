		...
		<div class="container-fluid">
			<div class="row page-titles">
				<div class="col-md-5 col-8 align-self-center">
					<h3 class="text-themecolor m-b-0 m-t-0">All Coupons</h3>
					<ol class="breadcrumb">
					...
					<div class="d-flex m-t-10 justify-content-end">
						<div class="d-flex m-r-20 m-l-10 hidden-md-down">
							<div class="chart-text m-r-10">
								<h6 class="m-b-0"><small>Total Coupons</small></h6>
					...
					<div class="row col-md-12">
						<div class="col-md-3" style="margin-bottom: 10px;">
							<div class="search-field">
								<input type="text" class="form-control" name="" id="search_title" placeholder="Search by coupon title">
							</div>
						</div>

						<div class="col-md-3" style="margin-bottom: 10px;">
							<div class="search-field">
								<input type="date" class="form-control" name="search_date" value="" id="search_start_date" placeholder="Search by date">
							</div>
						</div>
						...
						<div class="search-button" style="float:right;">
							...
							<a href="{{ url('/admin/coupon/create') }}" class="btn btn-success">Add Coupon</a>
	...
	<div class="modal fade" id="add-active-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<form method="post" action="{{ url('/admin/coupon/status') }}">
					@csrf
					<input type="hidden" name="coupon_id" id="status_coupon_id" value="">
	...
	<script>
		...
		$(document).ready(function(){
			$('#searchBtn').on('click',(function(e) {
				...
				var page = 1;
				fetchAll(page, search_title, search_start_date, searched_status);
			}));
			...
			function fetchAll(page, title, start_date, status){
				$.ajax({
					url:'{{ url("admin/coupon/search") }}?page='+page+'&title='+title+'&status='+status+'&start_date='+start_date,
					type: 'get',
