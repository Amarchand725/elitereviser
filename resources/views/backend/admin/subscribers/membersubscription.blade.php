		...
		<div class="container-fluid">
			<div class="row page-titles">
				<div class="col-md-5 col-8 align-self-center">
					<h3 class="text-themecolor m-b-0 m-t-0">All Member Subscriptions</h3>
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
						<li class="breadcrumb-item active">All Member Subscriptions</li>
					</ol>
				</div>
					...
					<div class="d-flex m-t-10 justify-content-end">
						<div class="d-flex m-r-20 m-l-10 hidden-md-down">
							<div class="chart-text m-r-10">
								<h6 class="m-b-0"><small>Total Member Subscriptions</small></h6>
					...
					<div class="row col-md-12">
						<div class="col-md-5" style="margin-bottom: 10px;">
							<div class="search-field">
								<select name="plan_id" id="plan_id" class="select2" style="width: 100%">
			...
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						<h4 class="card-title">All Member Subscriptions</h4>
	...
	<script>
		...
		$(document).ready(function(){
			$('#searchBtn').on('click',(function(e) {
				...
				fetchAll(plan_id, search_status);
			}));			

			function fetchAll(plan_id, status){
				$.ajax({
					url: '{{ url("/admin/membersubscriptions/get_all subscriptions") }}',
					type: 'post',
