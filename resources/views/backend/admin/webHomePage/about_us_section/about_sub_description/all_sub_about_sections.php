            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">About Us Sub Section</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">About Us Sub Section</li>
                        </ol>
                    </div>
   ...
   /* Categories Get With Search  */
	$(function() {
		...
		function ajaxlistCategories(page_url = false)
		{
			...
			var base_url = '<?php echo base_url('all-about-us-sub-with-ajax/0') ?>';
			if(page_url == false) {
...
<script type="text/javascript">
    function deleteData(id) {
        swal({title:"",
            text:"Are you sure you want to delete this section?",icon:"error",
            ...
            if (isConfirm) {
                $.ajax({
                    type:"POST",
                    url:"<?php echo base_url('delete-about-us-sub/'); ?>"+id,
                    dataType:'JSON',
                    success:function(data){
                        if(data==true){
                            $('#tr-remove'+id).fadeOut(500);
                            swal({title:"Successfully!",text:"About us sub section deleted successfully",icon:"success",timer:2000});
                        }
                    },
                    error:function (er) {
                        console.log(er);
