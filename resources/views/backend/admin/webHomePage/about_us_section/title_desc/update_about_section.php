<!-- Page wrapper  -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Update About Us</h3>
                        <ol class="breadcrumb">
                        ...
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
								<form action="#" enctype='multipart/form-data' class="form-horizontal" id="update_banner">
									<input type="hidden" class="form-control" name="ab_id" value="<?= $details[0]['ab_id']?>">
									<div class="form-body">
										<div class="row">
											<div class="col-md-12">
												<div class="form-group row">
													...
													<div class="col-md-9">
														<input type="text" class="form-control" name="ab_heading" value="<?= $details[0]['ab_heading']?>" placeholder="Title">
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group row">
													...
													<div class="col-md-9">
														<textarea type="text" name="ab_description" rows="10" class="form-control" placeholder="Description"><?= $details[0]['ab_description']?></textarea>
													</div>
												</div>
											</div>
										</div>
												...
												<div class="form-group row">
													...
													<div class="col-md-9">
														<select class="form-control" name="ab_status">
															<option  <?php if($details[0]['ab_status'] == 1){ echo"selected"; } ?> value="1">Active</option>
															<option  <?php if($details[0]['ab_status'] == 0){ echo"selected"; } ?> value="0">Inactive</option>
														</select>
													</div>
												</div>
											</div>
	...
	$('#update_banner').on('submit',function(e){
			...
			$.ajax({
				type:'POST',
				url:'<?php echo base_url('update-about-us'); ?>',
