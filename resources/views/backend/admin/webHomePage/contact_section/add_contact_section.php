<!-- Page wrapper  -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Add Contact Section </h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">Add Contact Section</li>
                        </ol>
                    </div>
                </div>
                <!-- ============================================================== -->
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Add Contact Section</h4>
                            </div>
                            <div class="card-body">
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group row">
													...
													<div class="col-md-9">
														<input type="text" class="form-control" name="ct_heading" placeholder="Title">
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group row">
													...
													<div class="col-md-9">
														<textarea rows="3" class="form-control" name="ct_description" placeholder="Description"></textarea>
													</div>
												</div>
											</div>
										</div>
	...
	$('#add_services_category').on('submit',function(e){
			...
			$.ajax({
				type:'POST',
				url:'<?php echo base_url('save-contact-section'); ?>',
