<!-- Page wrapper  -->
                        ...
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
								<form action="#" enctype='multipart/form-data' class="form-horizontal" id="update_banner">
									<input type="hidden" class="form-control" name="ssd_id" value="<?= $details[0]['ssd_id']?>">
									<div class="form-body">
										<div class="row">
											<div class="col-md-12">
												<div class="form-group row">
													...
													<div class="col-md-9">
														<input type="text" class="form-control" name="ssd_heading" value="<?= $details[0]['ssd_heading']?>" placeholder="Title">
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group row">
													...
													<div class="col-md-9">
														<textarea rows="3" class="form-control" name="ssd_description"  placeholder="Description"><?= $details[0]['ssd_description']?></textarea>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group row">
													...
													<div class="col-md-9">
														<input type="text" class="form-control" name="ssd_btn_text" value="<?= $details[0]['ssd_btn_text']?>" placeholder="Button Text">
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group row">
													...
													<div class="col-md-9">
														<input type="text" class="form-control" name="ssd_btn_link" value="<?= $details[0]['ssd_btn_link']?>" placeholder="Button Link">
													</div>
												</div>
											</div>
										</div>
												...
												<div class="form-group row">
													...
													<div class="col-md-9">
														<select class="form-control" name="ssd_status">
															<option  <?php if($details[0]['ssd_status'] == 1){ echo"selected"; } ?> value="1">Active</option>
															<option  <?php if($details[0]['ssd_status'] == 0){ echo"selected"; } ?> value="0">Inactive</option>
														</select>
													</div>
												</div>
											</div>
	...
	$('#update_banner').on('submit',function(e){
			...
			$.ajax({
				type:'POST',
				url:'<?php echo base_url('update-sub-service'); ?>',
