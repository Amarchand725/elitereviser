                        ...
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
								<form action="#" enctype='multipart/form-data' class="form-horizontal" id="update_banner">
									<input type="hidden" class="form-control" name="s_id" value="<?= $details[0]['s_id']?>">
									<div class="form-body">
										<div class="row">
											<div class="col-md-12">
												<div class="form-group row">
													...
													<div class="col-md-9">
														<input type="text" class="form-control" name="s_title" value="<?= $details[0]['s_title']?>" placeholder="Banner Title">
													</div>
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-md-12">
												<div class="form-group row">
													...
													<div class="col-md-9">
														<input type="text" class="form-control" name="s_sub_title"  value="<?= $details[0]['s_sub_title']?>" placeholder="Banner Sub Title">
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group row">
													...
													<div class="col-md-9">
														<input type="text" class="form-control" name="s_title_desc"  value="<?= $details[0]['s_title_desc']?>" placeholder="Banner Description">
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group row">
													...
													<div class="col-md-9">
														<input type="text" name="s_button_text" class="form-control" value="<?= $details[0]['s_button_text']?>"  placeholder="Banner Button Text"/>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group row">
													...
													<div class="col-md-9">
														<input type="text" name="s_button_link" class="form-control" value="<?= $details[0]['s_button_link']?>" placeholder="Banner Button Link"/>
													</div>
												</div>
											</div>
										</div>
												...
												<div class="form-group row">
													...
													<div class="col-md-9">
														<select class="form-control" name="s_status">
															<option  <?php if($details[0]['s_status'] == 1){ echo"selected"; } ?> value="1">Active</option>
															<option  <?php if($details[0]['s_status'] == 0){ echo"selected"; } ?> value="0">Inactive</option>
														</select>
													</div>
												</div>
											</div>
