<!-- Page wrapper  -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Add Service Category </h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Add Home Page Service Category</h4>
                            </div>
                            <div class="card-body">
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group row">
													...
													<div class="col-md-9">
														<input type="text" class="form-control" name="cat_head" placeholder="Service Category Title">
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group row">
													...
													<div class="col-md-9">
														<input type="file" class="" name="cat_img" placeholder="Category Image">
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group row">
													...
													<div class="col-md-9">
														<input type="text" name="cat_link" class="form-control" placeholder="Service Category Link"/>
													</div>
												</div>
											</div>
										</div>
	...
	$('#add_services_category').on('submit',function(e){
			...
			$.ajax({
				type:'POST',
				url:'<?php echo base_url('save-services-category'); ?>',
