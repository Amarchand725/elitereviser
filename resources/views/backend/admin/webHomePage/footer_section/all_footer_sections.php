            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Footer Section</h3>
                        <ol class="breadcrumb">
   ...
   /* Categories Get With Search  */
	$(function() {
		...
		function ajaxlistCategories(page_url = false)
		{
			...
			var base_url = '<?php echo base_url('all-footer-section-with-ajax/0') ?>';
			if(page_url == false) {
    ...
    function deleteData(id) {
        swal({title:"",
            ...
            if (isConfirm) {
                $.ajax({
                    type:"POST",
                    url:"<?php echo base_url('delete-footer-section/'); ?>"+id,
                    dataType:'JSON',
                    success:function(data){
                        if(data==true){
                            $('#tr-remove'+id).fadeOut(500);
                            swal({title:"Successfully!",text:"Footer section deleted successfully",icon:"success",timer:2000});
                        }
                    },
                    error:function (er) {
                        console.log(er);
