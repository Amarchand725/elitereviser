...
<body>
	<div class="bgimage">
		<div class="contant">
				...
				<br>
				<p>Following our recent discussion on <?php echo $discussion_date;?> with regards to Callix call answering services, I am happy to offer you our <b>Callix Premium Package </b> which has the following benefits:</b></p>
				...
				<p>  <b>•	A dedicated key account manager - </b>This person will manage your account on your behalf with the best interest of your business in mind. They will be available to you at any time and will ensure excellent delivery of services.</p>
				...
				<p>  <b>•	System integration – </b> By providing us with direct access to your system, we can provide your clients with real-time information.</p>
				...
				<p>  <b>•	Call forwarding - </b>If there are certain calls you would like us to forward to you (those that require your expertise for instance) kindly let us know. Please note that all calls forwarded to UAE landline numbers will bear no extra costs. However, standard carrier charges apply for the calls forwarded to mobile numbers.</p>
				...
				<p>  1. To notify your staff in case of emergencies. (Kindly define what constitutes as an emergency)</p>
				...
				<p> The value of the Callix Premium Package is <b><?php if(!empty($discount_price)){ echo $discount_price;}else{ echo"999";}?> AED/month</b> excluding VAT.</p>
				...
				<p><b><u>SO WHAT HAPPENS NEXT?</u></b></p>
				
				<div class="InnerDiv"><p>The next steps after this are as follows:</p>
				<p>  1. Once you approve the quotation (through a link sent to you via email or by accessing the quotation from your dashboard) an invoice will be automatically generated.</p>
				<p>   2. The expectation is for the payment to be done immediately after the invoice is generated.   Your receipt will be generated after payment. At the time of DID generation, the service will be deemed as active and you will be billed from that day until the 1st on a prorated basis if the payment date is any other date but the 1st.</p>
