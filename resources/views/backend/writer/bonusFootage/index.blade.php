				...
				<div class="col-md-12">
					<div class="row col-md-12">
						...
						<div class="search-button" style="float:right;">
							...
							<a href="{{ url('/artist/bonus_footage/create') }}" class="btn btn-success">Add Bonus Footage</a>
								...
								<tbody id="body">
									...
									@foreach ($models as $model)
										<tr id="tr-remove-{{ $model->id }}">
											...
											<td><a href="{{ url('artist/bonusfootage/show') }}/{{ $model->id }}">{{ $model->title }}</a></td>
											<td>
											...
											<td class="forlinks">
												<a href="{{ url('/admin/video/comments') }}/{{ $model->id }}" class="btn btn-sm btn-icon btn-info" data-toggle="tooltip" title="" data-original-title="Show All Comments" style="margin-right:5px"><i class="fa fa-comment"></i></a> 
												...
												<a href="{{ url('/artist/bonusfootage/edit') }}/{{ $model->id }}" class="btn btn-sm btn-icon btn-warning" data-toggle="tooltip" title="" data-original-title="Update video details"><i class="mdi mdi-border-color"></i></a> 
	...
	<script>
		...
		$(document).ready(function(){
			...
			function fetchAll(title, status){
				$.ajax({
					url: '{{ url("/artist/bonusfootage/search") }}',
					type: 'post',
