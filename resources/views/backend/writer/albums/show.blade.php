		...
		<div class="container-fluid">
			<div class="row page-titles">
				<div class="col-md-5 col-8 align-self-center">
					<h3 class="text-themecolor m-b-0 m-t-0">Show Song details</h3>
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
						<li class="breadcrumb-item active">Show Song details</li>
					</ol>
				</div>
			...
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						<h4 class="card-title">Show song details</h4>
						<div class="table-responsive">
							<div class="container">
								<table class="table">
									...
									<tr>
										<td>Actual Price</td>
										<td>${{ number_format($model->actual_price) }}.00</td>
									</tr>
									<tr>
										<td>Discount</td>
										<td>${{ number_format($model->discount) }}.00</td>
									</tr>
									<tr>
										<td>Sale Price</td>
										<td>${{ number_format($model->actual_price-$model->discount) }}.00</td>
									</tr>
									<tr>
										<td>Admin Charges {{ $commission }}%</td>
										<td>${{ $model->retail_price - $model->actual_price }}.00</td>
									</tr>
									<tr>
										<td>Retial Price</td>
										<td>${{ number_format($model->retail_price) }}.00</td>
									</tr>
									<tr>
										<td>Approved/Rejected By</td>
										<td>
											@if($model->hasApprovedBy)
												{{ $model->hasApprovedBy->name }}
											@endif
										</td>
									</tr>
									<tr>
