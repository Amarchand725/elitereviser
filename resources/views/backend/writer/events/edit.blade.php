		...
		<div class="container-fluid">
			<div class="row page-titles">
				<div class="col-md-5 col-8 align-self-center">
					<h3 class="text-themecolor m-b-0 m-t-0">Update Event</h3>
					<ol class="breadcrumb">
				...
				<div class="card">
					<div class="card-body">
						...
						<div class="table-responsive">
							<div class="container">
								<form method="post" id="event-form" name="even_form" action="{{ url('artist/event/update') }}" enctype="multipart/form-data">
									@csrf
									...
									<div class="modal-body">
										<div class="row">
											<div class="col-md-6">
												...
												<input type="text" value="{{ $details->title }}" name="title" id="title" class="form-control" placeholder="Enter event title">
												<span style="color: red">{{ $errors->first('title') }}</span>
											</div>
											<div class="col-md-6">
												<label for="">Venue <span style="color:red">*</span></label>
												<input type="text" value="{{ $details->venue }}" name="venue" class="form-control" placeholder="Enter venue place">
										...
										<div class="row">
											<div class="col-md-6">
												...
												<input type="date" name="start_date" id="start-date" value="{{ $details->start_date }}" min="{{ date('Y-m-d') }}" class="form-control">
											...
											<div class="col-md-6">
												...
												<input type="date" name="end_date" id="end-date" value="{{ $details->end_date }}" min="{{ date('Y-m-d') }}" class="form-control">
										...
										<div class="row">
											<div class="col-md-6">
												...
												<input type="time" name="start_time" value="{{ $details->start_time }}" class="form-control">
												<span style="color: red">{{ $errors->first('start_time') }}</span>
											</div>
											<div class="col-md-6">
												<label for="">End Time <span style="color:red">*</span></label>
												<input type="time" name="end_time" value="{{ $details->end_time }}" class="form-control">
												<span style="color: red">{{ $errors->first('end_time') }}</span>
											</div>
										</div>
				
										<div class="row">
											<div class="col-md-6" id="total_tickets" @if($details->free)style="display: none" @endif>
												<label for="">Total Tickets</label>
												<input type="number" name="total_tickets" value="{{ $details->total_tickets }}" id="" class="form-control" placeholder="Enter event no of tickets">
											</div>
											@if($details->free)
												<div class="col-md-6">
													<br />
													<div class="form-check form-check-inline">
														<input class="form-check-input" name="free" checked type="checkbox" id="free" value="1">
										...
										<div class="row" id="ticket-price" @if($details->free)style="display: none" @endif>
											<div class="col-md-6">
												<label for="">Per Ticket Actual Price </label>
												<input type="number" name="ticket_actual_price" value="{{ $details->ticket_actual_price }}" id="per_ticket_actual_price" class="form-control" placeholder="Enter per ticket price">
											</div>
											<div class="col-md-6">
												<label for="">Per Ticket Retial Price with Admin {{ $commission }}% Charges </label>
												<input type="number" name="ticket_retial_price" value="{{ $details->ticket_retial_price }}" id="per_ticket_retial_price" class="form-control" readonly>
											</div>
										</div>
										<div class="row">
											<div class="col-md-6">
												...
												<select name="status" id="" class="form-control">
													...
													<option value="0" {{ $details->status==0?'selected':'' }}>Deactive</option>
												</select>
											</div>
										</div>
										<div class="row">
											<div class="col-md-12">
												...
												<textarea name="description" id="" class="form-control" placeholder="describe event">{{ $details->description }}</textarea>
											</div>
										</div>
									</div>
