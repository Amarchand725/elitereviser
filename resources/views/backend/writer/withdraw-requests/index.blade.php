				...
				<div class="col-md-12">
					<div class="row col-md-12">
						...
						<div class="search-button" style="float:right;">
							...
							<a href="{{ url('/artist/withdrawrequest/create') }}" class="btn btn-success">Create New Request</a>
	...
	<script>
		...
		$(document).ready(function(){
			$('#searchBtn').on('click',(function(e) {
				...
				fetchAll(search_date, search_status);
			}));			

			function fetchAll(search_date, status){
				$.ajax({
					url: '{{ url("artist/withdraw/search") }}',
					type: 'post',
					data: {'search_date':search_date, 'status':status},
					headers: {
