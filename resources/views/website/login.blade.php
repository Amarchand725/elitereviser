 ...
 <!-- Banner -->
    ...
    <section class="editing loginpage">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
                 <h3 class="sec-heading">Login And Check Your Orders</h3>
          </div>
        ...
        <span style="color:Red;"> 
              <x-auth-validation-errors class="mb-4" :errors="$errors" /></span>
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-12 text-right">
                    <a href="{{ route('register')}}" class="btn business ripple-surface" style="width: 100%; background:#fcc002; color: #fff;"> Create Your Account  </a>
                  </div>
                </div>
              </form>
          </div>
