   ...
   @extends('website.layouts.master')
    @section('metatitle')
        <title>Non-English Speaker | Service </title>
    @endsection
    <!-- Banner -->
    @section('content')
            ...
            <div id="carouselBasicExample" class="carousel slide carousel-fade" data-mdb-ride="carousel"
              ...
              <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                  <img
                  src="{{ asset('public/assets/website')}}/images/box3.png" class="d-block w-100" alt="..."/>
                  <div class="carousel-caption d-none d-md-block">
                    <h5>Non-English Speaker</h5><br/><h6><strong>Academic, Business, Professional and Literary Work</strong> </h6>
    ...
    <section class="editing">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="sec-heading">Non-English Speaker</h3>
            <div class="sec-text"><p>We understand you take great pride in your academic, business, professional, or literary endeavors,  and you are non-English speaker. That is why we take great interest, as well. Our editors will correct misspellings, typos, and grammatical errors in your work to make it readable and articulate. We take pride in our services. You have nothing to worry about with us.</p>
             </div>
          </div>
        </div>
      </div>
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <select class=" custom-select my-1 mr-sm-2" id="inlineFormCustomSelectPref">
                        ...
                        <option value="4">Literary Work</option>
                    </select>
                  </div>
                  <div class="form-group col-md-3">
