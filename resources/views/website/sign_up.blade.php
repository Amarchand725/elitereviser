            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-row">
                   <div class="form-group col-md-6 text-left">
                    ...
                    <input type="name" name="name" :value="old('name')" required autofocus class="form-control" id="inputEmail4" placeholder="Name">
                  </div>
                  <div class="form-group col-md-6 text-left">
                  ...
                  <div class="form-group col-md-12 text-left">
                    ...
                    <input type="tel" name="phone_number" class="form-control" id="inputEmail4" placeholder="Phone Number">
                  </div>
                  <div class="form-group col-md-6 text-left">
