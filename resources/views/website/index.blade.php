            ...
            <div class="row bannersec">
                ...
                <div class="col-lg-6">
                    <div class="banner-text-left">
                        ...
                        <a href="{{ route('services')}}" class="btn business ripple-surface" style="margin-top:25px">Place Order</a>
                    </div>
                </div>
                <div class="col-lg-6">
                    {{-- <div class="banner-video-right">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-12 col-md-3 col-lg-3 dis-flex-end">
          <a href="{{ route('services')}}"  class="btn btn-business" style="background:#fcc002; color: #fff;">Get Started</a>
        </div>
      </div>
    </div>
  </section>
