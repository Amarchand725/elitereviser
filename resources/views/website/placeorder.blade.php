...
@section('metatitle')
  ...
  <title>{{ $service->title }} | Service Here </title>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="sec-text" data-desc="service description Here"><p>{{ $service->full_description }}</p>
    ...
    <form method="post" action="{{ route('customer.confirm-order') }}" enctype="multipart/form-data">
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-3">
          ...
          <label for="inputEmail4" data-here="1">Sub Service Here</label>

          <select class="custom-select my-1 mr-sm-2" name="sub_service" id="inlineFormCustomSelectPref" required>
        ...
        <div class="form-group col-md-3">
            ...
            <label for="inputEmail4">English Version Here</label>
