...
@section('content')
              ...
              <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                  ...
                  <div class="carousel-caption d-none d-md-block">
                    <h5>Professional</h5><br/><h6><strong>CV, Resume, Cover Letter and Interview Letter</strong> </h6>
    ...
    <section class="editing">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="sec-heading">Professional</h3>
    ...
    <form method="post" action="{{ route('customer.confirm-order') }}">
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-3">
            ...
            <input type="text" class="form-control" disabled="disabled"  name="total_words" id="total_words" placeholder="00">
        </div>
        <div class="form-group col-md-3">
        ...
        <div class="form-group col-md-3">
          ...
          <input type="text" class="form-control" disabled="disabled" name="total_amount" id="colFormLabel" value="$00" placeholder="Total Amount">
        </div>
