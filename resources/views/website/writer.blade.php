...
@section('content')
            ...
            <div id="carouselBasicExample" class="carousel slide carousel-fade" data-mdb-ride="carousel"></div>
              ...
              <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                  <img src="{{ asset('public/assets/website')}}/images/box6.png" class="d-block w-100" alt="..."/>
                    <div class="carousel-caption d-none d-md-block">
                    <h5>Writer</h5><br/><h6><strong>Book, Manuscript, Novel and Screenplay</strong> </h6>
   ...
   <section class="editing">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="sec-heading">Writer</h3>
            <div class="sec-text"><p>We are impressed with your writing. Your endeavor toward your work calls for an expert to edit and proofread it to correct misspellings, typos, and grammatical errors, to improve readability and  articulation. Being an author is a challenge on its own, and so, we are ready to help. Your citations or references will also be formatted to your specifications.</p>
             </div>
          </div>
        </div>
      </div>
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <select class=" custom-select my-1 mr-sm-2" id="inlineFormCustomSelectPref">
                        ...
                        <option value="4">Screenplay</option>
                    </select>
                  </div>
                  <div class="form-group col-md-3">
