        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="carousel-inner">
                    ...
                    <img
                        src="<?php echo e(asset('public/assets/website')); ?>/images/banner1.png" class="d-block w-100" alt="..."/>
                            ...
                            <div id="exTab2">
                                ...
                                <div class="tab-content" id="exTab2">
                                    <div class="tab-pane fade show active" id="login-panel" role="tabpanel" aria-labelledby="home-tab">
                                        <span style="color:Red;"> <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?></span>
                                        <form id="login" method="post" enctype="multipart/form-data" action="<?php echo e(route('login')); ?>" accept-charset="UTF-8">
                                            <?php echo csrf_field(); ?>
                                    ...
                                    <div class="tab-pane fade" id="sign-up" role="tabpanel" aria-labelledby="sign-up-tab">
                                        <form id="login" method="post" enctype="multipart/form-data" action="<?php echo e(route('register')); ?>" accept-charset="UTF-8">
                                            <?php echo csrf_field(); ?>
                                            <input type="hidden" name="order_details" value="order_details" id="">
                    ...
                    <?php else: ?>
                        <div id="quote-panel" class="panel panel-default panel-default-scribendi">
                            ...
                            <div class="panel-body">
                                <table id="quote-table" class="table" style=" width: 100%;">
                                    ...
                                    <tbody>
                                        <tr>
                                            <?php if(isset($data['service_type'])): ?>
                                                <td colspan="2">
                                                    <?php echo e($data['service_type']); ?>,<br />
                                                    <span style="display: inline-block;"><?php echo e($data['total_words']); ?> words completed within <br /> <?php echo e($data['trunaround_time']); ?> Hours</span><br />
                                                    <ul>
                                                        <?php $counter=0 ?>
                                                        <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <li><?php echo e(++$counter); ?> - <a href="<?php echo e(asset('public/assets/website/documents')); ?>/<?php echo e($document['name']); ?>" download>Attachment(<?php echo e($document['name']); ?>)</a></li>
                                            ...
                                            <?php else: ?>
                                                <td colspan="2">
                                                    ...
                                                    ?>
                                                    <?php echo e($service->title); ?> - <?php echo e($data['total_pages']); ?> pages, <br />
                                                </td>
                                            <?php endif; ?>

                                            <td id="checkout-base-price" class="price text-right">
                                                <?php echo e($data['currency']); ?> $<?php echo e(number_format($data['total_amount'], 2)); ?>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <ul>
                                                    ...
                                                    <?php $__currentLoopData = $instruction_files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $instruction_file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li><?php echo e(++$counter); ?> - <a href="<?php echo e(asset('public/assets/website/instruction_documents')); ?>/<?php echo e($instruction_file['name']); ?>" download>Attachment</a></li>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </ul>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Currency: <?php echo e($data['currency']); ?></td>
                        ...
                        <div class="text-right">
                            <a  href="<?php echo e(route('checkout')); ?>"  class="btn btn-scrib-cta btn-lg" id="start_checkout" name="start_checkout">
...
<?php echo $__env->make('website.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\elitereviser\resources\views/website/order.blade.php ENDPATH**/ ?>