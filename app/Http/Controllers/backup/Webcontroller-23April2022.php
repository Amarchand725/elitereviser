...
class Webcontroller extends Controller
{
    ...
    public function fileUploadPost(Request $request)
    {
        $validator = Validator::make($request->all(), array(
            'file' => 'required|mimes:pdf,docx,doc,xlsx,xls,txt,ods,zip',
...
//        echo $request->file->extension();exit;
...
//            \PhpOffice\PhpWord\Settings::setPdfRendererName('DomPDF');
             ...
             \PhpOffice\PhpSpreadsheet\Settings::setPdfRendererPath($domPdfPath);
            \PhpOffice\PhpSpreadsheet\Settings::setPdfRendererName('DomPDF');

            //Load word file
            $Content = \PhpOffice\PhpSpreadsheet\IOFactory::load(public_path('temp.xlsx'));
//            $Content = \PhpOffice\PhpWord\IOFactory::load(public_path('temp.xlsx'));
...
//            $PDFWriter = \PhpOffice\PhpSpreadsheet\IOFactory::createWriter($Content, 'PDF');
//            $PDFWriter->save(public_path('assets/website/documents/' . $fileName . '.pdf'));

            $PDFWriter = \PhpOffice\PhpSpreadsheet\IOFactory::createReader($Content, 'PDF');
            $PDFWriter->save(public_path('assets/website/documents/' . $fileName . '.pdf'));
...
//            echo public_path('temp.xls');
//            exit;

            //Load word file
//            $Content = \PhpOffice\PhpWord\IOFactory::load(public_path('temp.xls'));
...
//            $PDFWriter = \PhpOffice\PhpWord\IOFactory::createWriter($Content);
//            $PDFWriter->save(public_path('assets/website/documents/'.$fileName.'.pdf'));


            $PDFWriter = \PhpOffice\PhpWord\IOFactory::createWriter($Content, 'XLS');
            $PDFWriter->save(public_path('assets/website/documents/' . $fileName . '.xls'));
...
//            exit;
            ...
            $PDFWriter = \PhpOffice\PhpWord\IOFactory::createWriter($Content, 'txt');
//            $PDFWriter = \PhpOffice\PhpWord\IOFactory::createWriter($Content, 'PDF');
            $PDFWriter->save(public_path('assets/website/documents/' . $fileName . '.pdf'));
        ...
        if ($request->file->extension() == 'xlsx1') {

            $fName = $request->file->getClientOriginalName();

            $request->file->move(public_path('/'), 'temp.xlsx');
//            $request->file->move(public_path('/'), 'temp.pdf');
...
//            $PDFWriter->save(public_path('assets/website/documents/' . $fileName . '.pdf'));
        ...
        if ($request->file->extension() == 'xls1') {
...
////                    'file' => 'required',
//                    'file' => array('required,mimes:pdf,doc,docx,txt', 'max:2048'),
//                )
//            );

            $validator = Validator::make($request->all(), array(
//                'file' => 'required|mimes:pdf,docx,doc,xlsx,txt,ods,xlsx',
                'file' => 'required|mimes:pdf,docx,doc',
